...
{
    LssRuntimeOperation *operation = context;
                        ...
                        uint8_t *node_id_out)
{
    ...
    operation = (LssRuntimeOperation){.kind = LSS_RUNTIME_SELECT,
                          ...
                          &operation) == CO_LSSmaster_OK)
    {
        ...
        operation = (LssRuntimeOperation){.kind = LSS_RUNTIME_INQUIRE_NODE_ID,
                                          .value = &node_id};
