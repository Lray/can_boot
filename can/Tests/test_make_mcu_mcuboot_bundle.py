...
SCRIPT = pathlib.Path(__file__).resolve().parents[1] / "scripts" / "make_mcu_mcuboot_bundle.py"
SPEC = importlib.util.spec_from_file_location("make_mcu_mcuboot_bundle", SCRIPT)
