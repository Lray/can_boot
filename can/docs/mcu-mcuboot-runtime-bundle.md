# MCU MCUboot Runtime Bundle

`scripts/make_mcu_mcuboot_bundle.py` is the canonical release tool for both
MCU update packages and Boot YMODEM provisioning images. Its name and
...
python E:\T527\can_boot\can\scripts\make_mcu_mcuboot_bundle.py `
  --target-slot 1 `
  --version 1.2.0 `
  --security-counter 11 `
...
image. The MCU streams the received image bytes directly into the inactive
